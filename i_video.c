...
// Superseded by gl_video for glDoom
...
{
// FIXME put keyboard/mouse check code here...
/*
    event_t event;
...
void I_FinishUpdate(void)
{
    ...
    // This should call just the page swap routine so that
    // the game logic isn't short circuited...
/*
...
//    doShm = XShmQueryExtension(X_display);
	...
	if (displayname)
	{
	    ...
	    while (*d && (*d != ':')) d++;
	    if (*d) *d = 0;
	    if (!(!D_strcasecmp(displayname, "unix") || !*displayname)) doShm = false;
	}
    }
